...
wss.on('connection', function (ws) {
    ...
    ws.on('message', function (message) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            console.log("Ping em: ".concat(target));
            interval = setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, ping_1.default.promise.probe(target, {
                                    timeout: 2,
                        ...
                        case 2:
                            err_1 = _a.sent();
                            console.error('Erro ao pingar:', err_1);
                            ws.send(JSON.stringify({ target: target, alive: false, error: err_1 }));
                            return [3 /*break*/, 3];
